...
//        var width_input = "5"
        ...
        height_option = findViewById(com.arkountos.orcsattack.R.id.height_spinner)
//        width_option = findViewById(com.example.inittrack2.R.id.width_spinner)
        trees_probability_option = findViewById(com.arkountos.orcsattack.R.id.tree_probability_spinner)
        rocks_probability_option = findViewById(com.arkountos.orcsattack.R.id.rock_probability_spinner)
        enemies_quantity_option = findViewById(com.arkountos.orcsattack.R.id.enemies_quantity_spinner)
        map_style_option = findViewById(com.arkountos.orcsattack.R.id.map_style_spinner)
...
//        width_option.setSelection(9)
        ...
        val encounter_start_btn_done = findViewById<FloatingActionButton>(com.arkountos.orcsattack.R.id.encounter_start_done)
